...
<div class="album text-muted">
    <div class="container col-lg-4 col-md-6 col-sm-12">
        ...
        <div class="form-group">
            ...
            {!! Form::label('password_confirmation', trans('general.password_confirmation'),array('class'=>'control-label')) !!}
            {!! Form::password('password_confirmation', array('class'=>'form-control','placeholder'=>trans('general.password_confirmation'))) !!}
            ...
            {!! Form::select('role', $roles, isset($user['role_id']) ? $user['role_id']:'') !!}
